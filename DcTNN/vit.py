...
class FNetVIT(BaseVIT):
    """
    Cascade of fnetEncoder blocks: FNet Fourier token mixing over vertical column tokens.
    Used as a cascade stage like the others, so data consistency is applied after it by cascadeNet.
    """
    def __init__(self, N, layerNo=2, numCh=1, d_model=None, nhead=8, num_encoder_layers=2,
                    dim_feedforward=None, dropout=0.1, activation='relu',
                    layer_norm_eps=1e-05, batch_first=True, device=None, dtype=None,
